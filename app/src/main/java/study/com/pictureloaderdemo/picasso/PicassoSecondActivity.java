...
public class PicassoSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_picasso_second);
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                switch (scrollState) {
                    ...
                    case AbsListView.OnScrollListener.SCROLL_STATE_IDLE:
                        Picasso.with(PicassoSecondActivity.this).resumeTag(tag);
                        break;
                    //飞滑
                    case AbsListView.OnScrollListener.SCROLL_STATE_FLING:
                        Picasso.with(PicassoSecondActivity.this).pauseTag(tag);
                        break;
                    //触摸滚动
    ...
    private void updateView(List<FileItem> items) {
        ...
        GvAdapter adapter = new GvAdapter(this, items) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = View.inflate(PicassoSecondActivity.this, R.layout.item_gv_layout, null);
                }
                ...
                picasso.load(uri).placeholder(R.drawable.placeholder).into(iv);
...
//        items.add(0, fileItem10);
    ...
    protected void onDestroy() {
        super.onDestroy();
        Picasso.with(PicassoSecondActivity.this).cancelTag(tag);
    }
}
