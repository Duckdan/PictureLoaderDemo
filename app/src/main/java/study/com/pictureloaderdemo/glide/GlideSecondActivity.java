            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                switch (scrollState) {
                    ...
                    case AbsListView.OnScrollListener.SCROLL_STATE_IDLE:
                        Glide.with(GlideSecondActivity.this).resumeRequests();
                        break;
                    //飞滑
                    case AbsListView.OnScrollListener.SCROLL_STATE_FLING:
                        Glide.with(GlideSecondActivity.this).pauseRequests();
                        break;
                    //触摸滚动
    ...
    private void updateView(List<FileItem> items) {
        ...
        GvAdapter adapter = new GvAdapter(this, items) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = View.inflate(GlideSecondActivity.this, R.layout.item_gv_layout, null);
                }
                ...
                Glide.with(context).load(uri).placeholder(R.drawable.placeholder).into(iv);
